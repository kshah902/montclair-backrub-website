...
export const services: Service[] = [
  {
    ...
    name: "Table Massage",
    shortDescription:
      "Full-body therapeutic massage on a professional table for deep relaxation and relief. Can be combined with Reiki.",
    longDescription:
      "Our table massage is a full-body therapeutic experience designed to relieve tension, reduce stress, and promote deep relaxation. Whether you prefer Swedish, deep tissue, or a customized blend, our skilled therapists tailor each session to your individual needs. Reiki energy healing can also be incorporated into any table massage session for a holistic mind-body experience. Sessions are available in 30-minute, 1-hour, 1.5-hour, and 2-hour durations.",
    benefits: [
      "Relieves chronic muscle tension and pain",
      "Reduces stress and promotes relaxation",
      "Improves circulation and flexibility",
      "Can be combined with Reiki energy healing",
  ...
  },
  {
    ...
    name: "Reiki",
    shortDescription:
      "Japanese energy healing technique that promotes relaxation, stress reduction, and natural healing.",
    longDescription:
      "Reiki is a gentle, non-invasive energy healing practice rooted in Japanese tradition. During a session, the practitioner places their hands lightly on or just above the body to channel healing energy, promoting deep relaxation and supporting the body's natural ability to heal. Reiki can be experienced as a standalone session or combined with table massage for a comprehensive mind-body treatment. It is ideal for reducing stress, easing pain, and restoring emotional balance.",
    benefits: [
      "Promotes deep relaxation and stress relief",
      "Supports the body's natural healing processes",
      "Helps ease pain and tension",
      "Restores emotional and energetic balance",
      "Can be combined with table massage",
      "Gentle and non-invasive — suitable for everyone",
    ],
