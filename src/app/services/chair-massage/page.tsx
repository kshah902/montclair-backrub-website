...
const service = getServiceBySlug("chair-massage");

export const metadata: Metadata = createMetadata({
  title: "Chair Massage",
  description:
    "Quick, convenient chair massage sessions in Montclair, NJ. 10 to 30-minute sessions perfect for offices and events. Save up to 20% with packages.",
  path: "/services/chair-massage",
});
